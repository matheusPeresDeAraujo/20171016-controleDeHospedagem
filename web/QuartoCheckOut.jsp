                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Check Out Quarto</h3>
                            </div>
                            <div class="panel-body">
                                <form accept-charset="UTF-8" role="form" action="FrontController?action=DesocuparQuarto" method="post">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Estado" name="textEstado" type="text" value="disponivel" readonly="readonly"/>
                                        </div>
                                        <div class="form-group">
                                            <th><span>Cliente </span></th>
                                            <input name="textCliente" type="text" value="${cliente.codigo}" hidden/>
                                            <input class="form-control" placeholder="Cliente" name="textCliente" type="text" value="${cliente.nome}" readonly="readonly"/>
                                       </div>
                                        <input class="btn btn-lg btn-warning btn-block" type="submit" value="Desocupar">
                                    </fieldset>
                                </form>
                            </div>
                        </div>
